...
<link rel="stylesheet" href="<?php echo (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http" ) . "://$_SERVER[HTTP_HOST]/leilao_mvc/public/css/main.css"; ?>">
        ...
        <div class="container header-container">
            ...
            <nav class="nav" id="mainNav">
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="/admin" class="nav-link <?php echo $active_page === 'admin' ? 'active' : ''; ?>">Administração</a>
                    </li>
                    <?php endif; ?>
                    <?php if (isset($_SESSION['user_id'])): ?>
                    <li class="nav-item">
                        <a href="/leilao_mvc/logout" class="nav-link">Sair</a>
                    </li>
                    <li class="user-info">
