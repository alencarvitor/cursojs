    ...
    <div class="container">
        <div class="hero-content">
            ...
            <div>
                ...
                <a href="/login" class="btn btn-primary">Entrar para Participar</a>
                <?php endif; ?>
            </div>
            <img src="/public/images/sao_joao_batista.jpg" alt="São João Batista" class="hero-image">
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="products-grid">
            ...
            <div class="product-card">
                <img src="/public/images/produto-exemplo.jpg" alt="Produto Exemplo" class="product-image">
...
<section class="home-cta">
    <div class="container">
        <div class="cta-content">
            ...
            <a href="/register" class="btn btn-secondary">Cadastre-se Agora</a>
        </div>
    </div>
</section>
